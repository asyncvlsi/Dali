...
void ReportDaliUsage(std::ostream& output) {
  output
      ...
      << "  -enable_gridded_legalization_residual_feedback  accumulate analytical-to-legal anchor corrections\n"
...
bool ParseDaliCommandLine(int argc, char* argv[],
  ...
  for (int i = 1; i < argc;) {
    ...
    } else if (arg == "-enable_gridded_legalization_residual_feedback") {
      EnableConfigFlag("dali.enable_gridded_legalization_residual_feedback");
