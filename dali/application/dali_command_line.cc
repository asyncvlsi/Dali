...
void ReportDaliUsage(std::ostream& output) {
  output
      ...
      << "  -gridded_legalization_feedback <full/x_only/y_only/y_row_scale/y_row_hpwl/y_row_transactional/y_row_transactional_positive/none>\n"
    ...
    if (arg == "-lef") {
      ...
      if (!TryGetValue(argc, argv, &i, &value) ||
          (value != "full" && value != "x_only" && value != "y_only" &&
           ...
           value != "y_row_transactional_positive" && value != "none")) {
