...
void Dali::ShowParamsList() {
  LOG(info) << "Dali runtime parameters:\n"
            ...
            << "  enable_gridded_persistent_legalization_feedback: "
            << enable_gridded_persistent_legalization_feedback_ << "\n"
...
void Dali::LoadParamsFromConfig() {
  ...
  LoadBoolConfig(ConfigName(prefix_, "disable_gridded_legalization_feedback"),
                 &disable_gridded_legalization_feedback_);
  LoadBoolConfig(
      ConfigName(prefix_, "enable_gridded_persistent_legalization_feedback"),
      &enable_gridded_persistent_legalization_feedback_);
    ...
    if (enable_gridded_upper_bound_refiner_) {
      if (is_standard_cell_) {
        ...
        gb_placer_.SetUseRefinedUpperBoundAsAnchor(
            !disable_gridded_legalization_feedback_);
        gb_placer_.SetEnablePersistentLegalizationFeedback(
            enable_gridded_persistent_legalization_feedback_);
      }
    }
