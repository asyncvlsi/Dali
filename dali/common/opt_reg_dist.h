 ...
 *
 ******************************************************************************/
#ifndef DALI_COMMON_OPT_REG_DIST_H_
#define DALI_COMMON_OPT_REG_DIST_H_
...
/** Computes and exports each component's distance to its HPWL-optimal region.
 */
class OptimalRegionDistance {
 public:
...
#endif  // DALI_COMMON_OPT_REG_DIST_H_
