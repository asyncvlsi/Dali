...
class Circuit {
  ...
  private:
    ...
    BlockType *AddBlockTypeWithGridUnit(std::string &block_type_name,
                                        int width,
                                        int height);
    BlockType *AddWellTapBlockTypeWithGridUnit(std::string &block_type_name,
                                               int width,
                                               int height);
  ...
  public:
    ...
    Circuit();
    std::vector<BlkPairNets>
        blk_pair_net_list_; // lower triangle of the driver-load pair
    std::unordered_map<std::pair<int, int>,
                       int,
                       boost::hash<std::pair<int, int>>> blk_pair_map_;
    ...
    BlockType *AddBlockType(std::string &block_type_name,
                            double width,
                            double height);
    void SetBlockTypeSize(BlockType *blk_type_ptr, double width, double height);
    BlockType *AddWellTapBlockType(std::string &block_type_name,
                                   double width,
                                   double height);
    Pin *AddBlkTypePin(std::string &block_type_name,
                       std::string &pin_name,
                       bool is_input);
    Pin *AddBlkTypePin(BlockType *blk_type_ptr,
                       std::string &pin_name,
                       bool is_input);
    void AddBlkTypePinRect(std::string &block_type_name,
                           ...
                           double urx,
                           double ury);
    void AddBlkTypePinRect(Pin *pin_ptr,
                           double llx,
                           double lly,
                           double urx,
                           double ury);
    ...
    void AddBlkPinToNet(std::string &blk_name,
                        std::string &pin_name,
                        std::string &net_name);
    void ReportNetList();
    void ReportNetMap();
     ...
     * ************************************************/
    void SetNWellParams(double width,
                        double spacing,
                        double op_spacing,
                        double max_plug_dist,
                        double overhang);
    void SetPWellParams(double width,
                        double spacing,
                        double op_spacing,
                        double max_plug_dist,
                        double overhang);
    ...
    void setWellRect(std::string &blk_type_name,
                     bool is_N,
                     double lx,
                     double ly,
                     double ux,
    ...
    void SaveDefFile(std::string const &name_of_file,
    ...
    void SaveIODefFile(std::string const &name_of_file,
                       std::string const &def_file_name);
    void SaveDefWell(std::string const &name_of_file,
                     std::string const &def_file_name,
                     bool is_no_normal_cell = true);
    void SaveDefPPNPWell(std::string const &name_of_file,
                         std::string const &def_file_name);
    void SaveInstanceDefFile(std::string const &name_of_file,
                             std::string const &def_file_name);
