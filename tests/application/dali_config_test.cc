...
TEST_F(DaliConfigTest, KeepsDefaultRuntimeOptionsWhenConfigIsEmpty) {
  ...
  EXPECT_FALSE(options.enable_gridded_persistent_legalization_feedback);
...
TEST_F(DaliConfigTest, LoadsRuntimeOptionsFromActConfig) {
  ...
  config_set_int("dali.enable_gridded_persistent_legalization_feedback", 1);
  ...
  EXPECT_TRUE(options.enable_gridded_persistent_legalization_feedback);
