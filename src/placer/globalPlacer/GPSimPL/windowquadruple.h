...
#ifndef DALI_SRC_PLACER_GLOBALPLACER_GPSIMPL_WINDOWQUADRUPLE_H_
#define DALI_SRC_PLACER_GLOBALPLACER_GPSIMPL_WINDOWQUADRUPLE_H_
...
#endif //DALI_SRC_PLACER_GLOBALPLACER_GPSIMPL_WINDOWQUADRUPLE_H_
